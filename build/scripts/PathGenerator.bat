...
@rem ##########################################################################
@rem
@rem  PathGenerator startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and PATH_GENERATOR_OPTS to pass JVM options to this script.
...
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %PATH_GENERATOR_OPTS%  -classpath "%CLASSPATH%" org.usfirst.frc.team5740.Main %*
...
:fail
rem Set variable PATH_GENERATOR_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%PATH_GENERATOR_EXIT_CONSOLE%" exit 1
exit /b 1
